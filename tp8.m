function [ulEliteFunctionValue, llEliteFunctionValue, ulEliteIndiv, llEliteIndiv, ulFunctionEvaluations, llFunctionEvaluations,llCalls,gen,ulDim,llDim,ulPopSize,llPopSize] = tp8()

problemName = 'tp8';             % Test problem name
...
ulDimMax = 50*ones(1,ulDim);     % Maximum bound accross UL dimensions

llDimMin = -10*ones(1,llDim);    % Minimum bound accross LL dimensions
llDimMax = 20*ones(1,llDim);     % Maximum bound accross LL dimensions
