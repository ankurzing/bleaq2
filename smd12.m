function [ulEliteFunctionValue, llEliteFunctionValue, ulEliteIndiv, llEliteIndiv, ulFunctionEvaluations, llFunctionEvaluations,llCalls,gen,ulDim,llDim,ulPopSize,llPopSize] = smd12(ulPopSize, llPopSize, ulMaxGens, llMaxGens, ulDim, llDim)

problemName = 'smd12';            % Test problem name
...
eps = 0.00001;
llDimMin = [-5*ones(1,q) -pi/4*ones(1,r)+eps];  % Minimum bound accross LL dimensions
llDimMax = [10*ones(1,q)  pi/4*ones(1,r)-eps];  % Maximum bound accross LL dimensions
