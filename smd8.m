function [ulEliteFunctionValue, llEliteFunctionValue, ulEliteIndiv, llEliteIndiv, ulFunctionEvaluations, llFunctionEvaluations,llCalls,gen,ulDim,llDim,ulPopSize,llPopSize] = smd8(ulPopSize, llPopSize, ulMaxGens, llMaxGens, ulDim, llDim)

problemName = 'smd8';             % Test problem name
...
eps = 0.00001;
llDimMin = [-5*ones(1,q) -5*ones(1,r)]; % Minimum bound accross LL dimensions
