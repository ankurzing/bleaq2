function [ulEliteFunctionValue, llEliteFunctionValue, ulEliteIndiv, llEliteIndiv, ulFunctionEvaluations, llFunctionEvaluations,llCalls,gen,ulDim,llDim,ulPopSize,llPopSize] = smd3(ulPopSize, llPopSize, ulMaxGens, llMaxGens, ulDim, llDim)

problemName = 'smd3';             % Test problem name

if nargin==0
    ulPopSize=20;                 % Size of UL population
    ulMaxGens=500;               % Maximum number of generations allowed at UL
